...
public class MarginaliaHtmlAdapter extends AnnotationBaseHtmlAdapter<Marginalia> {
    ...
    void annotationAsHtml(BookCollection col, Book book, BookImage page, Marginalia annotation) throws XMLStreamException{
        ...
        addSearchableList(PEOPLE_LABEL, people, "people", COLLECTION_URI, writer, ISNIResourceDb.class);
        addSearchableList(BOOKS_LABEL, books, "book", COLLECTION_URI, writer, BookReferenceResourceDb.class);
        addSearchableList(LOCATIONS_LABEL, locs, "place", COLLECTION_URI, writer);
