...
public class PresentationTransformerTest extends BaseArchiveTest {
    ...
    public void setup() {
        ...
        rosa.iiif.image.core.IIIFImageRequestFormatter imageFormatter =
                new rosa.iiif.image.core.IIIFImageRequestFormatter(ENDPOINT_SCHEME, ENDPOINT_HOST, ENDPOINT_PORT, ENDPOINT_PREFIX);
