 ...
 */
public class IIIFPresentation2Servlet extends HttpServlet {
    ...
    public IIIFPresentation2Servlet() throws IOException {
        Util.loadSystemProperties();
        
        this.service = new ArchiveIIIFPresentationService(new IIIF2Serializer(), Util.getIIIFPresentationCache());
